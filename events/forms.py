...
class EventForm(forms.ModelForm):
    ...
    class Meta:
        model = EventModel
        fields = ("image", "title", "category", "content", "small_description", "venue_name", "event_address", "map_coordinates", "event_startdate", "event_enddate", "event_link")
        ...
        widgets = {
            ...
            'small_description': forms.TextInput(attrs={"class": "block p-3 md:text-base w-full text-sm text-custom-h outline-none placeholder:text-gray-400 bg-gray-50 rounded-lg border border-gray-300 focus:ring-custom-primary focus:border-custom-primary ease-linear transition-all duration-150"}),
            ...
            'event_startdate': forms.DateTimeInput(attrs={"type": "text", "step": "any", "class": "block p-3 md:text-base w-full text-sm text-custom-h outline-none placeholder:text-gray-400 bg-gray-50 rounded-lg border border-gray-300 focus:ring-custom-primary focus:border-custom-primary ease-linear transition-all duration-150", "placeholder": "yyyy-mm-dd h:m:s"}),
