    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_startdate', models.DateTimeField(validators=[django.core.validators.MinValueValidator(datetime.datetime(2024, 10, 27, 14, 38, 39, 407001, tzinfo=datetime.timezone.utc), 'Event start date and time cannot be in the past')])),
                ('event_enddate', models.DateTimeField(validators=[django.core.validators.MinValueValidator(datetime.datetime(2024, 10, 27, 14, 38, 39, 407054, tzinfo=datetime.timezone.utc), 'Event end date and time cannot be in the past')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale_start', models.DateTimeField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(datetime.datetime(2024, 10, 27, 14, 38, 39, 415052, tzinfo=datetime.timezone.utc), 'Ticket sale start date and time cannot be in the past')])),
                ('sale_end', models.DateTimeField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(datetime.datetime(2024, 10, 27, 14, 38, 39, 415105, tzinfo=datetime.timezone.utc), 'Ticket sale end date and time cannot be in the past')])),
