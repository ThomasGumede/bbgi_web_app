...
class BusinessForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'website': forms.URLInput(attrs={"class": "block p-2 md:text-base w-full text-sm text-custom-h outline-none placeholder:text-gray-400 bg-gray-50 rounded-lg border border-gray-300 focus:ring-custom-primary focus:border-custom-primary ease-linear transition-all duration-150", "placeholder": "e.g https://www.business.co.za"}),
