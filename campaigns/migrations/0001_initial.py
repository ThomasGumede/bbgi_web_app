    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateTimeField(default=campaigns.models.in_fourteen_days, validators=[django.core.validators.MinValueValidator(datetime.datetime(2025, 1, 1, 0, 29, 9, 301492, tzinfo=datetime.timezone.utc), "Date should not be less that today's date")])),
