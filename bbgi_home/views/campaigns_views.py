...
from bbgi_home.forms import CampaignUpdateStatusForm
...
def campaign_details(request, campaign_slug):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("bbgi_home:campaign-details", campaign_slug=campaign.slug)
...
def delete_contribution(request, contribution_id):
    ...
    if contribution.paid == PaymentStatus.PAID:
        ...
        return redirect("bbgi_home:all-contributions")
