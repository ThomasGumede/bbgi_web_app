...
from markets.views.quotation import create_quotation, qoutations, delete_quote, manage_quotations, get_qoutations, request_service, quotation_details
...
urlpatterns = [
    ...
    path("manage/quotations", qoutations, name="qoutations"),
    ...
    path("manage/quotations/<service_slug>/delete=<uuid:quotation_id>", delete_quote, name="delete-quote"),
    path("manage/<uuid:service_id>/update/business=<slug:listing_slug>", update_service, name="update-service"),
    path("manage/<uuid:service_id>/delete/business=<slug:listing_slug>", delete_service, name="delete-service"),
    ...
    # Management
    path("manage/services/<quotation_id>", quotation_details, name="manage-quote")
]
