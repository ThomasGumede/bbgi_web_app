...
class ServiceForm(forms.ModelForm):
    ...
    class Meta:
        model = Service
        fields = ("image", "title", "description", "price_decription", "price", "discount_percentage", "discount_description")
        ...
        widgets = {
            ...
            'discount_description': forms.TextInput(attrs={"class": "text-custom-text pl-5 pr-[50px]  outline-none border-2 border-[#e4ecf2] focus:border focus:border-custom-primary h-[65px] block w-full rounded-none focus:ring-0 focus:outline-none placeholder:text-custom-text placeholder:text-sm"}),
